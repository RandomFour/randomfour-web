const PrivacyPolicy = () => {
  return (
    <main className="max-w-xl mx-auto prose">
      <div className="p-5">
        <div className="pb-4">
        ...
        <div>
          <p>Last Updated: 2025-05-07</p>

          <p>
            Thank you for visiting RandomFour LLC ("we," "us," or "our"). This
            Privacy Policy outlines how we collect, use, and protect your
            personal and non-personal information when you use our website
            located at <a href="https://randomfour.co">randomfour.co</a> (the "Website").
          </p>
          ...
          <p>
            ...
            experience and communicate with you effectively.
            <br />
            <strong>Email:</strong> We collect your email address to send you
            important information regarding your orders, updates, and
            communication.
            <br />
          ...
          <p>
            ShipFast is not intended for children under the age of 13. We do not
          ...
          <p>
            Email:{" "}
            <a href="mailto:hello@michaltakac.com">hello@michaltakac.com</a>
          </p>
          <p>
          ...
          <p>
            By using products and services from RandomFour LLC, you consent to
            the terms of this Privacy Policy.
          </p>
        </div>
        <a href="/" className="btn btn-ghost p-5">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 20 20"
            fill="currentColor"
